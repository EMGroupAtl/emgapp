...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "emgapp.iOS.AppDelegate, emgapp.iOS", "FinishedLaunching");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_9 (self, _cmd, &managed_method, "emgapp.iOS.AppDelegate, emgapp.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation Microsoft_Azure_Mobile_Crashes_iOS_Bindings_CrashesInitializationDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_81 (self, _cmd, &managed_method, "Microsoft.Azure.Mobile.Crashes.iOS.Bindings.CrashesInitializationDelegate, Microsoft.Azure.Mobile.Crashes.iOS.Bindings", "SetUpCrashHandlers");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "emgapp.iOS.AppDelegate, emgapp.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [58].handle = objc_getClass ("CKShareMetadata");
	...
	__xamarin_class_map [231].handle = [MSWrapperSdk class];
	__xamarin_class_map [232].handle = [MSDevice class];
	__xamarin_class_map [233].handle = [MSLogger class];
	__xamarin_class_map [234].handle = [MSMobileCenter class];
	__xamarin_class_map [235].handle = [MSServiceAbstract class];
	__xamarin_class_map [236].handle = [MSWrapperLogger class];
	__xamarin_class_map [237].handle = [MSCrashes class];
	__xamarin_class_map [238].handle = [MSErrorReport class];
	__xamarin_class_map [239].handle = [MSException class];
	__xamarin_class_map [240].handle = [MSStackFrame class];
	__xamarin_class_map [241].handle = [MSWrapperExceptionManager class];
	__xamarin_class_map [242].handle = [Microsoft_Azure_Mobile_Crashes_iOS_Bindings_CrashesInitializationDelegate class];
